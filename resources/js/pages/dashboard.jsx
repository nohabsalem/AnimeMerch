            ...
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                <div className="grid auto-rows-min gap-4 md:grid-cols-3">
                    <div className="dark:border-sidebar-border relative flex items-center overflow-hidden rounded-xl border-2 border-[#6C3989] p-4">
                        ...
                        <div className="ml-4">
                            <Link href="/commandes" className="font-semibold text-lg">Vos commandes </Link>
                    ...
                    <div className="dark:border-sidebar-border relative flex items-center overflow-hidden rounded-xl border-2 border-[#6C3989] p-4">
                        ...
                        <div className="ml-4">
                            <Link href="/cordonnées" className="font-semibold text-lg">Adresses  </Link>
                    ...
                    <div className="dark:border-sidebar-border relative flex items-center overflow-hidden rounded-xl border-2 border-[#6C3989] p-4">
                        ...
                        <div className="ml-4">
                            <Link href="/paiements" className="font-semibold text-lg">Vos paiements  </Link>
                            <p className="text-sm text-gray-600">Afficher toutes les transactions, gérer les modes de paiement et les paramètres.</p>
                        </div>
                    </div>
                </div >
            </div >
